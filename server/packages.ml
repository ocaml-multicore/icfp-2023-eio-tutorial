...
let read_versions store (entry : Store.Value.Tree.entry) : candidates Lwt.t =
...
let get_versions (t:t) name =
  ...
  | Some versions -> OpamPackage.Version.Map.map Lazy.force versions
